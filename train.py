...
argparser.add_argument("-1", "--first_round", action="store_true",
    help="Run first-round: train with 20000 iterations")
argparser.add_argument("-2", "--second_round", action="store_true",
    help="Run second-round: apply pruning and its additional training")
args = argparser.parse_args()

from tensorflow.examples.tutorials.mnist import input_data
mnist = input_data.read_data_sets('/tmp/data/', one_hot=True)
if (args.first_round or args.second_round) == False:
